...
logo.style.background = `linear-gradient(84.37deg, ${getRGB() + '2.27%'}, ${getRGB() + '92.26%'})`
...
getData('/wallets?id=' + recent_card.id)
.then(res => {
...
logo.innerHTML = `
   <h2 class="letter">${JSON.stringify(recent_card.name).slice(1,2)}</h2>
`
